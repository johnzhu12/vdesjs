<template>
  <li v-drag-item :style="{ top: zoneTop, left: zoneLeft, width: zoneWidth, height: zoneHeight }">
    <ul
      v-change-size
      class="hz-m-box"
      :class="{
    ...
    >
      ...
      <li title="删除该热区" v-show="!hideZone" class="hz-u-close hz-icon hz-icon-trash" @click.stop="delItem(index)"></li>
